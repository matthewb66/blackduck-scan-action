...
def attempt_indirect_upgrade(pm, deps_list, upgrade_dict, detect_jar, connectopts, bd, upgrade_indirect, upgrade_major):
...
def find_upgrade_versions(dirdep, versions_list, origin_dict, guidance_list, upgrade_major):
